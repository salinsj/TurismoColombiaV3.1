...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titulo = (TextView) findViewById(R.id.tvmapa);
        regresar = (Button) findViewById(R.id.bRegresar);

        Bundle coordenadas = getIntent().getExtras();

        latitud = coordenadas.getDouble("latitude");
        longitud = coordenadas.getDouble("longitude");

        name = coordenadas.getString("nombre");

        titulo.setText(String.valueOf(name));
