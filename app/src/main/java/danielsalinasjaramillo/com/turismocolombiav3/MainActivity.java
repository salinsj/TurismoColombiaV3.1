...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opciones = new String[] {"Inicio", "Hoteles","Bares", "Sitios Turísticos", "Información demográfica"};
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch(position){
                    case 0: fragment = new PublicidadFragment();
                        break;
                    case 1: fragment =  new HotelesFragment();
                        break;
                    case 2: fragment = new BaresFragment();
                        break;
                    case 3: fragment = new TuristicosFragment();
                        break;
                    case 4: fragment = new DemografiaFragment();
                        break;
                }
